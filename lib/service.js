...
export class Service {
  constructor (options) {
    ...
    // setup s3 service
    if (!options.s3ServicePath) throw new Error('constructor: \'options.s3ServicePath\' param must be provided')
    this.s3Service = options.app.service(options.s3ServicePath)
